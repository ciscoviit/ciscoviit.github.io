        ...
        <div className="formbold-form-wrapper">
          ...
          <form onSubmit={handleSubmit}>
            <div className="formbold-mb-5">
              <label className="formbold-form-label" htmlFor="teamName">
                Team Name:
              </label>
              <input
                type="text"
            ...
            <div className="formbold-mb-5">
              <label className="formbold-form-label" htmlFor="captainName">
                Captain Name:
              </label>
              <input
                type="text"
            ...
            <div className="formbold-mb-5">
              <label className="formbold-form-label" htmlFor="email">
                Email:
              </label>
              <input
                type="email"
            ...
            <div className="formbold-mb-5">
              <label className="formbold-form-label" htmlFor="phone">
                Phone:
              </label>
              <input
                type="tel"
              ...
              {teamMembers.map((teamMember, index) => {
                return (
                  <div key={index}>
                    <input
                      type="text"
                      className="formbold-form-input1"
                      name="name"
          ...
          <div>
            ...
            {/* <img
              className="center"
              src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d0/QR_code_for_mobile_English_Wikipedia.svg/444px-QR_code_for_mobile_English_Wikipedia.svg.png"
              alt="Pay Here"
            /> */}
          </div>
          {registrationComplete && (
